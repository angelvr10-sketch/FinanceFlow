...
export const CategoryIcons: Record<string, React.ReactNode> = {
  ...
  other: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-5 h-5">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 11h.01M7 15h.01M11 7h.01M11 11h.01M11 15h.01M15 7h.01M15 11h.01M15 15h.01M19 7h.01M19 11h.01M19 15h.01M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2z" />
    </svg>
  ),
};
...
export const getDefaultIcon = (category: string): string => {
  ...
  if (cat.includes('transporte') || cat.includes('uber') || cat.includes('gasolina')) return 'transport';
  if (cat.includes('ocio') || cat.includes('cine') || cat.includes('viaje')) return 'leisure';
