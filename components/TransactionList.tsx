            ...
            <div className="flex items-center gap-3">
              ...
              <div className="overflow-hidden">
                <div className="flex items-center gap-1">
                  ...
                  {t.isRecurring && (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 text-indigo-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <title>Transacción recurrente</title>
